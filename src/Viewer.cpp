...
void Viewer::mainLoop() {
    NeuronScene scene(width, height);
    scene.load("");
...
bool Viewer::checkDeviceExtensionSupport(VkPhysicalDevice device) {
...
/* Debug */
void Viewer::populateDebugMessengerCreateInfo(VkDebugUtilsMessengerCreateInfoEXT& createInfo) {
    createInfo = {};
